// 采购谈判风格测试 - 场景对话版 v4.1（情绪值系统）
// 8 场景 × 7 轮 = 56 轮对话
// 每轮二选一，测量 4 个维度（A/I, R/T, C/B, D/P）
// 情绪值：agg=1(强硬/质疑/对抗), agg=0(温和/理解/合作)
        ...
        rounds: [
            {
                ...
                options: [
                    { text: '铜价我天天看，没涨这么多吧？', score: 'A', agg: 1 },
                    { text: '这价格虚高，咱俩都清楚。', score: 'I', agg: 0 }
                ]
            },
            {
                dim: 'RT',
                opponent: {
                    default: '哎呀，你可能只看期货价。我们实际采购含运费、关税，涨得更多。这是成本表。',
                    highAgg: '（皱眉）你这话说的... 期货价是期货价，我们实际采购含运费、关税，涨得更多。这是成本表。',
                    lowAgg: '（点头）你能理解就好... 但期货价归期货价，我们实际采购含运费、关税，涨得更多。这是成本表。'
                },
                options: [
                    { text: '理解你们难处，但 20% 太高了，再商量商量？', score: 'R', agg: 0 },
                    { text: '商业归商业，按数据说话。', score: 'T', agg: 1 }
                ]
            },
            {
                dim: 'CB',
                opponent: {
                    default: '现在供应链紧张，很多客户排队要货。我是优先保你们。',
                    highAgg: '（语气变硬）你这样说话... 现在供应链紧张，很多客户排队要货。我是优先保你们。',
                    lowAgg: '（语气缓和）有你这句话... 现在供应链紧张，很多客户排队要货。我是优先保你们。'
                },
                options: [
                    { text: '那我们得评估风险，开发备选供应商了。', score: 'C', agg: 1 },
                    { text: '行，我相信你，说说具体方案。', score: 'B', agg: 0 }
                ]
            },
            {
                dim: 'DP',
                opponent: {
                    default: '备选供应商？现在哪家产能不紧张？',
                    highAgg: '（冷笑）威胁我？备选供应商？现在哪家产能不紧张？',
                    lowAgg: '（苦笑）备选供应商... 现在哪家产能不紧张？'
                },
                options: [
                    { text: '不试试怎么知道？我们有的是选择。', score: 'D', agg: 1 },
                    { text: '一起找解决方案呗，比如签年度合同锁价？', score: 'P', agg: 0 }
                ]
            },
            {
                dim: 'AI',
                opponent: {
                    default: '年度合同可以，但价格得按 18% 涨。',
                    highAgg: '（拍桌子）18% 不能再少！年度合同可以，但价格得按 18% 涨。',
                    lowAgg: '（松口气）年度合同可以，但价格得按 18% 涨。'
                },
                options: [
                    { text: '18% 不可能，最多 10%。', score: 'A', agg: 1 },
                    { text: '行，你算算成本，给我个实在价。', score: 'I', agg: 0 }
                ]
            },
            {
                dim: 'RT',
                opponent: {
                    default: '10%... 让我跟公司争取一下。这样，我看看成本结构哪里能优化。',
                    highAgg: '（摇头）10%... 你这是在为难我。这样，我看看成本结构哪里能优化。',
                    lowAgg: '（思考）10%... 让我跟公司争取一下。这样，我看看成本结构哪里能优化。'
                },
                options: [
                    { text: '张总费心了，等你好消息。', score: 'R', agg: 0 },
                    { text: '好，记得提供详细成本分析。', score: 'T', agg: 1 }
                ]
            },
            {
                dim: 'CB',
                opponent: {
                    default: '争取到了，14% 涨价，但预付款从 30% 提到 40%。',
                    highAgg: '（不情愿）争取到了，14% 涨价，但预付款从 30% 提到 40%。',
                    lowAgg: '（微笑）争取到了，14% 涨价，但预付款从 30% 提到 40%。'
                },
                options: [
                    { text: '14% 可以，预付款我得跟财务商量。', score: 'C', agg: 1 },
                    { text: '行，就按你说的办。', score: 'B', agg: 0 }
                ]
            }
        ]
    },
        ...
        rounds: [
            {
                ...
                options: [
                    { text: '一周？我们产线得停工！损失谁承担？', score: 'D', agg: 1 },
                    { text: '先别急，一起想想补救办法。', score: 'P', agg: 0 }
                ]
            },
            {
                dim: 'AI',
                opponent: {
                    default: '我们正在抢修，但配件得从德国运。',
                    highAgg: '（擦汗）我们正在抢修，但配件得从德国运。',
                    lowAgg: '（感激）我们正在抢修，但配件得从德国运。'
                },
                options: [
                    { text: '配件型号发我，我帮你们找现货。', score: 'A', agg: 0 },
                    { text: '德国运过来得多久？有准信吗？', score: 'I', agg: 1 }
                ]
            },
            {
                dim: 'RT',
                opponent: {
                    default: '大概 5 天。王经理，这次真是意外。',
                    highAgg: '（紧张）大概 5 天。王经理，这次真是意外。',
                    lowAgg: '（松口气）大概 5 天。王经理，这次真是意外。'
                },
                options: [
                    { text: '意外归意外，合同条款得按约定来。', score: 'T', agg: 1 },
                    { text: '理解，谁都有困难时候。', score: 'R', agg: 0 }
                ]
            },
            {
                dim: 'CB',
                opponent: {
                    default: '那... 能不能先把合格的那 30% 发了？',
                    highAgg: '（小心翼翼）那... 能不能先把合格的那 30% 发了？',
                    lowAgg: '（试探）那... 能不能先把合格的那 30% 发了？'
                },
                options: [
                    { text: '行，但剩下 70% 得给确切时间。', score: 'C', agg: 1 },
                    { text: '30% 不够，至少得 60%。', score: 'B', agg: 0 }
                ]
            },
            {
                dim: 'DP',
                opponent: {
                    default: '60% 真做不到，机器还没修好。',
                    highAgg: '（为难）60% 真做不到，机器还没修好。',
                    lowAgg: '（苦笑）60% 真做不到，机器还没修好。'
                },
                options: [
                    { text: '做不到也得做，这是你们的责任。', score: 'D', agg: 1 },
                    { text: '那这样，我帮你们联系同行借产能？', score: 'P', agg: 0 }
                ]
            },
            {
                dim: 'AI',
                opponent: {
                    default: '这... 要是能借到当然好。',
                    highAgg: '（犹豫）这... 要是能借到当然好。',
                    lowAgg: '（期待）这... 要是能借到当然好。'
                },
                options: [
                    { text: '我现在就打几个电话问问。', score: 'A', agg: 0 },
                    { text: '你们自己没同行资源吗？', score: 'I', agg: 1 }
                ]
            },
            {
                dim: 'RT',
                opponent: {
                    default: '有是有，但人家也得排期。',
                    highAgg: '（无奈）有是有，但人家也得排期。',
                    lowAgg: '（感激）有是有，但人家也得排期。'
                },
                options: [
                    { text: '行，我等你消息，尽快回复我。', score: 'R', agg: 0 },
                    { text: '别等了，直接要他们联系方式。', score: 'T', agg: 1 }
                ]
            }
        ]
    },
